...
def main():
    ...
    #add the attractions to a list so they can be directly passed for a GET request
    #or they can be removed for a POST request. The POST includes the filters the user selected
    add_records_to_list()
